...
public class UIDraw : MonoBehaviour {
    ...
    void OnGUI()
    {
        ...
        drawer.label(player_speedStr).Draw(32, 109, 5);
        drawer.label(gun_damage1Str).Draw(32, 116, 5);
        drawer.label(gun_damage2Str).Draw(32, 123, 5);
    }
    ...
    {
        player_speedStr = value.ToString();
    }
    ...
    {
        gun1_dmg = value;
        gun_damage1Str = gun1_dmg.ToString() + " / " + gun1_fr.ToString("0.00");
    }
    private void takeGun2Damage(int value)
    {
        gun2_dmg = value;
        gun_damage2Str = gun2_dmg.ToString() + " / " + gun2_fr.ToString("0.00");
    }
